  ...
  return (
    <section id="projects" className="px-4 sm:px-6 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {displayProjects.map((project, index) => (
            <Link
              ...
              className={cn(
                "group relative overflow-hidden rounded-xl border bg-card/40 p-6 sm:p-7 glass transition-all duration-400 active:scale-[0.99] hover-lift hover:border-primary/40 hover:bg-card/70 animate-fade-in-up block",
                project.highlight
        ...
        {showSeeMore && (
          <div className="mt-12 flex justify-center animate-fade-in-up stagger-3">
            <Link
              href="/projects"
              className="group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-lg border border-primary/20 bg-primary/5 px-8 py-3 font-mono text-sm text-primary transition-all duration-300 hover:bg-primary/10 hover:border-primary/50"
            >
