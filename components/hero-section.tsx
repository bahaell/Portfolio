...
const roles = ["full-stack systems", "cloud infrastructure", "deployment pipelines", "intelligent features", "scalable APIs"]
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Software engineer focused on full-stack development, cloud architecture, and DevOps. I design and build
              production-ready systems — from database schemas to deployment pipelines. Currently seeking{" "}
