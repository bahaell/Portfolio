...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/bahaell", handle: "@bahaell", icon: Github },
  { label: "LinkedIn", href: "https://linkedin.com/in/baha-ellouze", handle: "/in/baha-ellouze", icon: Linkedin },
  { label: "Email", href: "mailto:Bahaaellouze@gmail.com", handle: "Bahaaellouze@gmail.com", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="pt-2">
              <a
                href="mailto:bahaaellouze@gmail.com"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} BeE — All experiments reserved
          </p>
        </div>
      </div>
    </footer>
