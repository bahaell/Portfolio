...
const wipItems = [
  {
    ...
    url: "https://github.com/bahaell/next16-docker-tw4-starter",
    branch: "main",
    commits: 47,
  },
  {
    ...
    url: "https://github.com/bahaell/handbuilt-linux",
    branch: "develop",
    commits: 32,
  },
  {
    ...
    url: "https://github.com/bahaell/einbiogpt",
    branch: "main",
    commits: 89,
  },
  {
    ...
    progress: 75,
    lastUpdated: "Apr 2025",
    url: "https://github.com/bahaell/llm-practice",
    branch: "feature/mcp",
    commits: 56,
  },
  {
    ...
    progress: 45,
    lastUpdated: "Dec 2024",
    url: "https://github.com/bahaell/einui",
    branch: "main",
    commits: 28,
  },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/bahaell/active</span>
