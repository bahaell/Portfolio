...
export const metadata: Metadata = {
  ...
  description:
    "A digital workshop where code meets curiosity. Experiments, prototypes, and open-source artifacts by Bahaeddine Ellouze.",
  ...
  authors: [{ name: "Bahaeddine Ellouze", url: "https://github.com/bahaell" }], // TODO: Update GitHub URL if provided
  creator: "Bahaeddine Ellouze",
  publisher: "Bahaeddine Ellouze",
  generator: "v0.app",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "/",
    title: "BeE — Bahaeddine Ellouze's Portfolio",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BeE — Bahaeddine Ellouze's Portfolio",
      },
    ],
  },
  robots: {
