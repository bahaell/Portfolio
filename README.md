...
A modern Portfolio and portfolio built with Next.js, React and Radix UI.

Version: `0.1.1`

## What the project does

BeE is a lightweight, opinionated portfolio and playground intended for experimenting with editor-like components and small developer tools. It demonstrates a modern stack including Next.js 16, React 19, TypeScript, Tailwind CSS and Radix UI primitives.
...
- Create an issue: <https://github.com/bahaell/code-forge/issues>
- For quick questions, open a discussion or file a concise issue with reproduction steps.

Who maintains this project

- Maintainer: Bahaeddine Ellouze — listed as the package author.
