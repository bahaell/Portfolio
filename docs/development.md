...
\`\`\`bash
# Clone repository
git clone https://github.com/bahaell/code-forge.git
cd BeE
...
export const metadata: Metadata = {
  title: 'About | BeE',
  description: 'About Bahaeddine Ellouze and this Portfolio',
}
...
- **GitHub Issues**: https://github.com/bahaell/code-forge/issues
