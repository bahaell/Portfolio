...
BeE is a Next.js 16 + React 19 personal portfolio and Portfolio built with modern web technologies. It demonstrates Next.js App Router patterns, Tailwind CSS v4 styling, and a component-driven architecture.
