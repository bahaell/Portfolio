...
git remote add origin https://github.com/yourusername/BeE.git
...
NEXT_PUBLIC_GITHUB_URL=https://github.com/bahaell
NEXT_PUBLIC_LINKEDIN_URL=https://linkedin.com/in/baha-ellouze
\`\`\`
...
\`\`\`bash
cd /var/www
sudo git clone https://github.com/yourusername/BeE.git
cd BeE
\`\`\`
...
# Create config
sudo nano /etc/nginx/sites-available/BeE
\`\`\`
...
location /_next/static {
    alias /var/www/BeE/.next/static;
    expires 365d;
    add_header Cache-Control "public, immutable";
}

location /static {
    alias /var/www/BeE/public;
    expires 365d;
    add_header Cache-Control "public, immutable";
}
\`\`\`
...
0 2 * * * /usr/bin/pg_dump BeE > /backups/BeE-$(date +\%Y\%m\%d).sql
\`\`\`
...
rsync -avz /var/www/BeE/public/ backup-server:/backups/BeE-public/
\`\`\`
